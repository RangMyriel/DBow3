...
namespace DBoW3
{
    ...
    class DBOW_API Vocabulary
    {
      ...
      public:
        ...
        /**
         * Creates a vocabulary from the training features, setting the
         * branching factor and the depth levels of the tree
         * @param training_features
         * @param k branching factor
         * @param L depth levels
         */
        ...
        /**
         * Creates a vocabulary from the training features, setting the
         * branching factor nad the depth levels of the tree, and the weighting
         * and scoring schemes
         */
        virtual void
        create(const std::vector<std::vector<cv::Mat>>& training_features,
        ...
        /**
         * Returns whether the vocabulary is empty (i.e. it has not been
         * trained)
        ...
        void transformParallel(const std::vector<cv::Mat>& features,
                               BowVector&                  v) const;
         ...
         * @param levelsup levels to go up the vocabulary tree to get the node
         * index
         */
        virtual void transform(const std::vector<cv::Mat>& features,
        ...
        /**
         * Returns the id of the node that is "levelsup" levels from the word
         * given
         * @param wid word id
         * @param levelsup 0..L
         * @return node id. if levelsup is 0, returns the node id associated to
         * the word id
         */
        ...
        /**
         * Saves the vocabulary into a file. If filename extension contains
         * .yml, opencv YALM format is used. Otherwise, binary format is
         * employed
         * @param filename
         */
        void save(const std::string& filename,
                  bool               binary_compressed = true) const;
        ...
        bool loadMapped(const std::string& filename);

        /**
         * Stops those words whose weight is below minWeight.
         * Words are stopped by setting their weight to 0. There are not
         * returned later when transforming image features into vectors.
         * Note that when using IDF or TF_IDF, the weight is the idf part,
         * which is equivalent to -log(f), where f is the frequency of the
         * word (f = Ni/N, Ni: number of training images where the word is
         * present, N: number of training images). Note that the old weight
         * is forgotten, and subsequent calls to this function with a lower
         * minWeight have no effect.
         * @return number of words stopped now
         */
        virtual int stopWords(double minWeight);

        /** Returns the size of the descriptor employed. If the Vocabulary is
         * empty, returns -1
         */
      ...
      protected:
         ...
         */
        void
        getFeatures(const std::vector<std::vector<cv::Mat>>& training_features,
        ...
        /**
         * Creates a level in the tree, under the parent, by running kmeans
         * with a descriptor set, and recursively creates the subsequent
         * levels too
        ...
        /**
         * Sets the weights of the nodes of tree according to the given
         * features. Before calling this function, the nodes and the words must
         * be already created (by calling HKmeansStep and createWords)
         * @param features
         */
      ...
      public:
        ...
        inline Node* getNode(uint32_t idx) { return &m_nodes[idx]; }

        inline std::vector<Node>&  getNodes() { return m_nodes; }
        inline std::vector<Node*>& getWords() { return m_words; }
    };
